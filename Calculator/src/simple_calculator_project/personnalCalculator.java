...
public class personnalCalculator {
	...
	static int amount = 0, income = 0, profit = 0, HomeExp = 0, totalAdd = 0, sadd = 0, badd = 0, BusExp = 0,
			NetAmountIncome = 0;
	...
	static void comeHere() {
		...
		while (entLoop) {
			...
			case 1:
				...
				break;
			case 2:
				System.out.println("1->Home Expense");
				...
				if (exoper == 1) {
					...
					System.out.println("Expenses="+NetAmountIncome);
				} else if (exoper == 2) {
					boolean ExLoop = true;
					while (ExLoop) {
						System.out.println("1.Rent Expense");
				...
				break;
			case 3:
				System.out.println("Networth=" + personnalCalculator.NetWorth(totalAdd, (HomeExp + BusExp)));
				break;
